...
public class VectorSubCategory extends Vector<SubCategory> implements KvmSerializable {
    
    
    public VectorSubCategory(){}
    
    public VectorSubCategory(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    SubCategory j1= new SubCategory(j0);
                    add(j1);
                }
            }
        }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        info.name = "SubCategory";
        info.type = SubCategory.class;
    }
