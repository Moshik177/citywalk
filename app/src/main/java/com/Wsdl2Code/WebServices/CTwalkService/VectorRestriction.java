...
public class VectorRestriction extends Vector<Restriction> implements KvmSerializable {
    
    
    public VectorRestriction(){}
    
    public VectorRestriction(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    Restriction j1= new Restriction(j0);
                    add(j1);
                }
            }
        }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        info.name = "Restriction";
        info.type = Restriction.class;
    }
