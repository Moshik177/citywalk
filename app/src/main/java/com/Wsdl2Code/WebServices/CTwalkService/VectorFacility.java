...
public class VectorFacility extends Vector<Facility> implements KvmSerializable {
    
    
    public VectorFacility(){}
    
    public VectorFacility(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
