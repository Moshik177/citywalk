...
public class Point implements KvmSerializable {
    ...
    public Point(String i_Budget, int i_CityId, String i_Facilities, String i_HouseNumber, double i_Lat, double i_Lng, String i_LocalName, String i_Name,
                 int i_NeighborhoodId, int i_NumberOfRates, int i_PointId, int i_Rating, String i_Restrictions, int i_StreetId, String i_SubCategories, String i_Types)
    {
        Budget = i_Budget;
        CityId = i_CityId;
        Facilities = i_Facilities;
        HouseNumber = i_HouseNumber;
        Lat = i_Lat;
        Lng = i_Lng;
        LocalName = i_LocalName;
        Name = i_Name;
        NeighborhoodId = i_NeighborhoodId;
        NumberOfRates = i_NumberOfRates;
        PointId = i_PointId;
        Rating = i_Rating;
        Restrictions = i_Restrictions;
        StreetId = i_StreetId;
        SubCategories = i_SubCategories;
        Types = i_Types;
    ...
    public Point(SoapObject soapObject)
    {
        ...
        {
            Object obj = soapObject.getProperty("Facilities");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                Facilities = j.toString();
            }else if (obj!= null && obj instanceof String){
                Facilities = (String) obj;
            }
        }
        ...
        {
            Object obj = soapObject.getProperty("Restrictions");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                Restrictions = j.toString();
            }else if (obj!= null && obj instanceof String){
                Restrictions = (String) obj;
            }
        }
        ...
        {
            Object obj = soapObject.getProperty("SubCategories");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                SubCategories = j.toString();
            }else if (obj!= null && obj instanceof String){
                SubCategories = (String) obj;
            }
        }
        if (soapObject.hasProperty("Types"))
        {
            Object obj = soapObject.getProperty("Types");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                Types = j.toString();
            }else if (obj!= null && obj instanceof String){
